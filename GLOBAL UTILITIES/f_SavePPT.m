...
function f_SavePPT(filespec,titletext,prnopt)
...
if isempty(titletext)
    ...
    tempFile = [ tempdir '\temp.eps'];    
    new_slide = invoke(op.Slides,'Add',slide_count,12);           
    print(gcf, '-depsc2', '-r300',tempFile);        
    Image1 = new_slide.Shapes.AddPicture(tempFile,'msoFalse','msoTrue',100,20,500,500);
    delete(tempFile);
	if 0
    new_slide = invoke(op.Slides,'Add',slide_count,12);
