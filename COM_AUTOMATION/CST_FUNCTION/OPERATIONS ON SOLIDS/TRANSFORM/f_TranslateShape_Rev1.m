function status = f_TranslateShape_Rev1(oMWS,component,name,vector,repetitions,bUsePickedPoints,bInvertPickedPoints,shape)
%% TRANSLATE SHAPE
...
elseif strcmp(shape,'Curve')
    historyStr = sprintf('%s\n\t.Transform "%s", "%s"',historyStr,'Curve','Translate');
end
historyStr = sprintf('%s\nEnd With',historyStr);
