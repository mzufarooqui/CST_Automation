function [totSolverTime totSimulationTime tolMeshCell totMemConsume totMatCalcTime totSolSetupTime totSolverLoopTime totSolPosTime totGPU_MemUsage] = f_ReadCST_Model_Log_File_Rev01(fileName,PrintVal)
gpuMemCnt     = [];
matCalTimCnt  = [];
solSetTimCnt  = [];
solLoopTimCnt = [];
