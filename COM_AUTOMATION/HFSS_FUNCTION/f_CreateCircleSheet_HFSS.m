function f_CreateCircleSheet_HFSS(oProject,activeDsg,itemName,coord,radius,materialValue,axis)
...
%   true)
invoke(oEditor,'CreateCircle',{'NAME:CircleParameters', 'IsCovered:=', 'true', ...
    'XCenter:=', [ num2str(coord(1)) 'mm' ], 'YCenter:=', [ num2str(coord(2)) 'mm' ], 'ZCenter:=', [ num2str(coord(3)) 'mm' ], 'Radius:=',[ radius 'mm' ], 'WhichAxis:=', axis, 'NumSegments:=', '0'}, ...
